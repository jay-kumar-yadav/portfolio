...
>
    ...
    <div class="flex-1 flex justify-betweeen gap-4 items-end">
        <div
        class="ml-auto cursor-pointer hover:text-slate-950 duration-200 relative after:absolute after:top-0 after:right-full after:bg-white after:w-full after:h-0 hover:after:h-full hover:after:translate-x-full after:duration-200 after:z-[-1] overflow-hidden"
